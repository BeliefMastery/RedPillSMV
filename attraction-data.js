...
const MALE_COALITION_QUESTIONS = [
  // Courage (3)
  { id: 'courage_1', type: 'value_allocation', allocationTotal: 100, subcategory: 'courage', text: 'When faced with physical confrontation or danger, how do you typically respond? (split 100% across what fits)', weight: 1.0, options: OPTS, optionLabels: ['Freeze, avoid, or seek escape', 'Retreat and de-escalate; minimize conflict', 'Stand ground; respond only if necessary', 'Confront directly; protect self/others', 'Seek to dominate; high risk tolerance'] },
  ...
  { id: 'courage_3', type: 'value_allocation', allocationTotal: 100, subcategory: 'courage', text: 'In group settings when conflict arises, how does your response usually distribute? (split 100% across what fits)', weight: 1.0, options: OPTS, optionLabels: ['Always step back; avoid entirely', 'Usually avoid; intervene only if forced', 'Depends on stakes; selective engagement', 'Usually step in; take ownership', 'Always lead; handle conflict directly'] },
  // Control (3)
...
const MALE_REPRODUCTIVE_QUESTIONS = [
  ...
  { id: 'protector_2', type: 'value_allocation', allocationTotal: 100, subcategory: 'protector', text: 'If someone you care about were threatened, how would your response likely distribute? (split 100% across what fits)', weight: 1.0, options: OPTS, optionLabels: ['Avoid; call for help', 'Uncertain; might intervene', 'Would try to de-escalate or protect', 'Would step in and protect', 'Would intervene decisively without hesitation'] },
  ...
  { id: 'parental_2', type: 'value_allocation', allocationTotal: 100, subcategory: 'parentalInvestor', text: 'If your partner became pregnant, how would your reaction realistically distribute? (split 100% across what fits)', weight: 1.0, options: OPTS, optionLabels: ['Panic; would want to avoid', 'Stress; uncertain about commitment', 'Mixed; would work through it', 'Accept; would step up', 'Embrace; ready to parent'] },
...
const MALE_RAD_ACTIVITY_QUESTIONS = [
  ...
  { id: 'rad_2', type: 'value_allocation', allocationTotal: 100, subcategory: 'radActivity', weight: 0.30, text: 'How do you spend your non-work time? (split 100% across what fits)', options: OPTS, optionLabels: [
...
const MALE_AXIS_QUESTIONS = [
  ...
  { id: 'phys_7', subcategory: 'physicalGenetic', text: 'How balanced are your facial features and body proportions overall—things others might notice before they know you? (Examples of unevenness: noticeably different eye size or eyelid fold; nose visibly off-center; one shoulder or hip clearly higher; scarring or features that draw the eye on one side. This is about typical first glance, not your worth.)', weight: 0.9, options: OPTS, optionLabels: ['Strong unevenness—often the first thing people clock', 'Noticeable imbalance—some comments or double-takes', 'Minor unevenness—most people don’t focus on it', 'Fairly even—nothing that usually stands out', 'Very even—balanced look overall'], helpText: 'Answer from a normal mirror or photos at conversation distance, not microscopic self-inspection.' },
  ...
  { id: 'phys_9', subcategory: 'physicalGenetic', text: 'How would you rate your voice, posture, and the impression you give in the first moments someone sees you (before you’ve said much)?', weight: 0.85, options: OPTS, optionLabels: ['Weak; easily overlooked', 'Below average', 'Average', 'Above average; solid presence', 'Strong; memorable immediately'] },
...
const FEMALE_REPRODUCTIVE_QUESTIONS = [
  ...
  { id: 'collab_1', type: 'value_allocation', allocationTotal: 100, subcategory: 'collaborativeTrust', text: 'How does your relationship cooperation typically distribute across these patterns? (split 100% across what fits)', weight: 1.0, options: OPTS, optionLabels: ['Poorly; frequent conflict', 'Struggle; drama often', 'Moderately; some conflict', 'Well; mostly cooperative', 'Exceptionally; easy partnership'] },
...
const FEMALE_AXIS_QUESTIONS = [
  ...
  { id: 'fert_2', subcategory: 'fertility', text: 'Looking at yourself straight on in the mirror (or in fitted clothes), how does your waist relate to your hips? We’re not asking for measurements—just the silhouette others usually see.', weight: 1.15, options: OPTS, optionLabels: ['Waist and hips similar width; weight mostly midsection', 'Slight waist; hips only a bit wider', 'Clear waist; hips noticeably wider than waist', 'Pronounced hourglass—waist much narrower than hips', 'Very defined narrow waist vs full hips/thighs'], helpText: 'If your weight sits mostly in the belly with little hip curve, choose the first or second anchor. If you carry more in hips/thighs with a clear waist indent, use the upper anchors.' },
  ...
  { id: 'fert_5', subcategory: 'fertility', text: 'How balanced are your facial features and body proportions—unevenness others might notice at a first meeting? (Examples: uneven eyes or smile line; nose off-center; shoulders or hips visibly different heights; one leg shorter or limp affecting stance; visible scarring on one side. Not about perfection—about what typically reads at a glance.)', weight: 0.9, options: OPTS, optionLabels: ['Strong unevenness—often the first thing people clock', 'Noticeable imbalance—sometimes commented on', 'Minor unevenness—most people don’t focus on it', 'Fairly even—nothing that usually stands out', 'Very even—balanced look overall'], helpText: 'Use everyday mirror distance; skip nitpicking small asymmetries no one sees without staring.' },
  ...
  { id: 'fert_8', subcategory: 'fertility', text: 'Net calibration: how strong is your overall physical first-impression signal in typical dating or social settings (face + body + vitality together)?', weight: 0.65, options: OPTS, optionLabels: ['Weak overall signal', 'Below average', 'Average', 'Above average', 'Strong overall signal'] },
...
export const KEEPER_SWEEPER_CHART = [
  ...
  { segment: 'sleepers', label: 'Sleepers', desc: 'Babe, I dunno where I\'m gonna be in 3 weeks, ya know?' },
