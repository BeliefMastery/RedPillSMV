...
function buildMaleClusters() {
  ...
  const axis = [
    ...
    ...[1, 2, 3, 4, 6].map(i => qw(`perf_${i}`, 'performanceStatus', 1.0)),
    qw('perf_5', 'performanceStatus', 0.9),
    qw('perf_7', 'performanceStatus', 0.95),
    qw('perf_8', 'performanceStatus', 0.9),
    qw('perf_9', 'performanceStatus', 0.65),
    qw('perf_10', 'performanceStatus', 0.65),
    qw('perf_11', 'performanceStatus', 0.65),
    qw('mmp_1', 'mateMarketProof', 0.95),
    qw('mmp_2', 'mateMarketProof', 0.95),
    qw('mmp_3', 'mateMarketProof', 0.95),
...
function buildFemaleClusters() {
  ...
  const repro = [
    ...
    qw('pat_4', 'paternityCertainty', 0.85),
